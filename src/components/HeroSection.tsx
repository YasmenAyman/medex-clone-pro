...
const statCards = [
  {
    ...
    iconBg: "bg-red-500",
    position: "left-[10%] lg:left-[15%] top-[55%] lg:top-[60%]",
    label: "98.5% Success Rate"
  },
  {
    icon: <ShieldCheck className="h-4 w-4 text-white fill-current" />,
    iconBg: "bg-red-500",
    position: "left-1/2 -translate-x-1/2 bottom-[20%] sm:bottom-[22%]",
    label: "98.5% Success Rate"
  },
  {
    icon: <Heart className="h-4 w-4 text-white fill-current" />,
    iconBg: "bg-red-500",
    position: "right-[10%] lg:right-[15%] top-[55%] lg:top-[60%]",
    label: "98.5% Success Rate"
  },
];
  ...
  return (
    <section className="relative overflow-hidden bg-white min-h-[600px] lg:min-h-[1000px] flex flex-col">
      ...
      <div className="absolute top-0 left-0 right-0 z-[2] pointer-events-none">
        <img src={heroTop} alt="" className="w-full object-cover object-top" style={{ maxHeight: "120px" }} />
      </div>

      {/* Slider */}
      <div className="relative z-10 flex-1 flex flex-col pt-[160px] pb-[80px]">
        ...
        {statCards.map((card, i) => (
          <div
            key={i}
            className={`absolute ${card.position} z-20 bg-white rounded-2xl p-4 lg:p-6 shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-primary/5 hidden sm:flex flex-col items-center text-center transform hover:scale-105 transition-transform duration-300`}
      ...
      <div className="absolute bottom-0 left-0 right-0 z-[5] pointer-events-none">
        <img src={heroBottom} alt="Dental implants" className="w-full object-cover object-top" style={{ maxHeight: "320px" }} />
      </div>
    </section>
  );
};
